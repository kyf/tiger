	...
	var listtpl = [
				'<li data-id="577999267" id="msgListItem577999267" class="message_item ">',
					'<table style="width:100%;text-align:center;">',
						'<tr>',
							'<td style="width:70px;">',
								'<a href="/message/detail?orderid={orderid}"><img src="http://admin.6renyou.com/statics/socketchat/img/default-user.jpg" /></a>',
							'</td>',
							'<td style="text-align:left;">',
								'<div><a href="/message/detail?orderid={orderid}">{from_name}</a></div>',
								'<div>{message}</div>',
							'</td>',
